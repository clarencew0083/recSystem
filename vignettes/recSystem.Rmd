...
If you are curious as to what exactly is going on under the hood, the next picture @Woods may shed some light.
...
3. **Meta Learning**
    ...
    A new dataset is formed where each row is the collection of the 12 meta features extracted from one dataset of the six datasets. These twelve features together form the feature space \(F\). 
